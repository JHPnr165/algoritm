...
/**
 * Depth first job assignment calculation Class. Without branching.
 * 
 * @author Marko Tandre
 *
 */
public class DepthNoBranch {
...
//					}
		...
		System.out.print("DepthFirstNoBranch time: ");
	...
	public void saveData() {
		Writer writer = new Writer("DepthNoBranch.out");
		String toWrite = "";
		toWrite += best.cost;
		for(int i = 0; i < size; i++) {
