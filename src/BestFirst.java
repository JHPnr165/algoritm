...
/**
 * Best before branch and bound Class.
 * 
 * @author Marko Tandre
 *
 */
public class BestFirst {
	...
	/**
	 * Best first branch and bound method.
	 * 
	 * @return Node with best job assignment info.
	 */
	public Node bestFirst() {
		...
		System.out.print("BestFirst time: ");
	...
	public void saveData() {
		Writer writer = new Writer("BestFirst.out");
		String toWrite = "";
		toWrite += best.cost;
		for(int i = 0; i < size; i++) {
